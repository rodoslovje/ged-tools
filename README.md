...
| Preset | Description |
|---|---|
| `mft_webtrees` | WebTrees compatibility for MacFamilyTree exports. Cleaners: `dd_mmm_yyyy`, `name_placeholder`. Strippers: `ste`, `stf`, `sto`, `bkm`, `addr_longlati`, `change_date`, `create_date`, `indi_race`. Transformers: `fid_fsftid`, `latr_even`. |
